      ...
      <div className="row g-5">
            ...
            <div className="card-body p-4">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  ...
                  <textarea className="form-control" id="message" rows="5" value={form.message} onChange={handleChange} required />
                </div>
        ...
        <div className="col-lg-5">
          <div className="bg-light p-4 rounded h-100">
            ...
            <div>
              <button className="btn btn-link text-success fs-4 me-3 p-0">
